...
if __name__ == '__main__':
    ...
    try_dataloader = create_dataloader(data_dir, color_train, scan_train, 100)
    for i,(names, scan, color, cgray) in enumerate(try_dataloader):
        print('Train Batch',i)
        print(names)
    ...
    try_dataloader = create_testdataloader(data_dir, color_test, scan_test, 100)
    for i, (names, scan, color, cgray )in enumerate(try_dataloader):
