...
test_edge_gan:
	python main_edge_gan.py --data_path ../datasets/128dim_slices/slices/  --image_dim 128 --test_mode True --device cuda --custom_name wasserstein_lite_test --description lap4_edge_mult_1_gfast_weight_clip_0_point_1_augmented
...
run_edge_gan:
	...
	python main_edge_gan.py --data_path ../datasets/128dim_slices/slices/  --image_dim 128 --device cuda --custom_name wasserstein_lite --description lap4_edge_mult_1_gfast_weight_clip_3_point_0_tv_loss_0_generator_512_layer1_batch_size30
