...
test_edge_gan:
	python main_edge_gan.py --data_path ../datasets/128dim_slices_augmented_affine/slices/  --image_dim 128 --test_mode True --device cuda --custom_name wasserstein_lite_test --description lap4_edge_mult_1_gfast_weight_clip_3_point_0_tv_loss_1eminus6_generator_512_layer1_batch_size35_discriminator_512
...
run_edge_gan:
	...
	python main_edge_gan.py --data_path ../datasets/128dim_slices_augmented_affine/slices/  --image_dim 128 --device cuda --custom_name wasserstein_lite_cgan --description lap4_edge_mult_1_gfast_weight_clip_1_point_0_tv_loss_1eminus6_generator_512_layer1_batch_size40_discriminator_512_noise_ranged_augmented_affine
