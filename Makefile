...
run_edge_gan:
	 python main_edge_gan.py --data_path ../datasets/random_axis/subslice_f/  --image_dim 128 --device cuda --custom_name random_axis_wasserstein_lite_sobel --description sobel_with_edge_no_tv_gen_iter_2__clip_point1\ model_change 
