...
test_edge_gan:
	python main_edge_gan.py --data_path ../datasets/randSlice/subslices/  --image_dim 128 --test_mode True --device cuda --custom_name wasserstein_lite_test_sobel_randslice --description _lap4_gfast_weight_clip_3_point_0_edge_1point0_tv_loss_1eminus8 
...
run_edge_gan:
	...
	python main_edge_gan.py --data_path ../datasets/randSlice/subslices/  --image_dim 128 --device cuda --custom_name wasserstein_lite_sobel_randslice_big --description sobel_with_edge_tv1e8 
	#--load_segmentation "../segmentation vol_generate/data/128dim_slices/fcn/weights.pth"
