...
test_edge_gan:
	python main_edge_gan.py --data_path ../datasets/128dim_slices/slices/  --image_dim 128 --test_mode True --device cuda --custom_name normgan_lite_test_sobel --description _lap4_gfast_weight_clip_3_point_0_edge_1point0_tv_loss_1eminus8 
...
run_edge_gan:
	...
	python main_edge_gan.py --data_path ../datasets/128dim_slices/slices/  --image_dim 128 --device cuda --custom_name normgan_lite_sobel --description sobel_with_1point5_edge_relu_mse_loss 
	#--load_segmentation "../segmentation vol_generate/data/128dim_slices/fcn/weights.pth"
