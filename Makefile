...
run_edge_gan:
	...
	python main_edge_gan.py --data_path ../datasets/random_axis/subslice_f/non_zero/  --image_dim 128 --device cuda --custom_name random_axis_model_redux_wgan_gp_lite_sobel_l1_non_zero --description sobel_edge_without_dataparallel_grad_penalty_10_non_zerodset
	#--load_segmentation "../segmentation vol_generate/data/128dim_slices/fcn/weights.pth"
